package com.lin.commons.utils.zk;
...
//    }
    ...
    public final String metaRoot; // zk上SimpleMQ的根目录
    public final String consumersPath; //zk上存放消费者的基本路劲
    public final String brokerIdsPath; //zk上存放brokerid的基本路劲
    @Deprecated
    ...
    //meta/consumers/group(具体的组)/ids/owners/topic(具体的topic)
    ...
    /**
     * meta中broker存放路径
     * "meta/brokers/ids:data",data中包含broker地址
     * 获取指定brokerId的master,
    ...
    /**
     * this.brokerIdsPath = "meta/brokers/ids"
    ...
    /**
     * "meta/brokers/topics-pub" 存放topics相关信息，如topic被发布到了那个机器上
