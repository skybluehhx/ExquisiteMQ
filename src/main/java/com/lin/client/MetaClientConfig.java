...
import com.lin.commons.utils.DiamondUtils;
 ...
 * 客户端配置几类
 * @author jianglinzou
 * @date 2019/3/11 下午1:17
 */
public class MetaClientConfig implements Serializable {

    static final long serialVersionUID = -1L;
    protected String serverUrl; //直连的url,这里一般不设置为空
    ...
    public void setZkConfig(final ZkUtils.ZKConfig zkConfig) {
        if (zkConfig == null) {
