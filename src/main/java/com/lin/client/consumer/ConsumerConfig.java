 ...
 *
 * @author jianglinzou
 * @date 2019/3/11 下午1:22
 */
public class ConsumerConfig extends MetaClientConfig {

    static final long serialVersionUID = -1L;
    // TODO: 2019/3/17 先设置为1个
    private int fetchRunnerCount = 1;//Runtime.getRuntime().availableProcessors();
    ...
    /**
     * @param consumerId 消费者id，如果不设置，系统会自动产生 "ip_时间"
     * @param group
     */
     ...
     *
     * @param commitOffsetPeriodInMills 毫秒
     */
